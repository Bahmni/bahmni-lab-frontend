...
;(self.webpackChunk_openmrs_esm_implementer_tools_app =
  ...
  [735],
  {
    ...
    8447: (e, r, t) => {
      ...
      var w = (k.prototype = new S())
      ;(w.constructor = k), n(w, g.prototype), (w.isPureReactComponent = !0)
      var j = {current: null},
      ...
      function $(e, r, t) {
        ...
        if (null != r)
          ...
          r))
            O.call(r, n) && !C.hasOwnProperty(n) && (o[n] = r[n])
      ...
      function I(e, r, t, n) {
        ...
        if (f) return t(n, e, '' === r ? '.' + U(e, 0) : r), 1
        if (((f = 0), (r = '' === r ? '.' : r + ':'), Array.isArray(e)))
          ...
          typeof (i =
            null === e || 'object' != typeof e
              ? null
              : 'function' == typeof (i = (h && e[h]) || e['@@iterator'])
              ? i
              : null)
        )
          for (e = i.call(e), l = 0; !(o = e.next()).done; )
            f += I((o = o.value), (i = r + U(o, l++)), t, n)
        else if ('object' === o)
          throw ((t = '' + e),
          Error(
            v(
      ...
      ;(r.Children = {
        ...
        (r.cloneElement = function(e, r, t) {
          ...
          if (null != r) {
            if (
              (void 0 !== r.ref && ((f = r.ref), (l = j.current)),
              void 0 !== r.key && (c = '' + r.key),
